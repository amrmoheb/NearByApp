...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="NearByApp",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9NearByApp11AppDelegate")
...
@interface NearByPlacesVC (SWIFT_EXTENSION(NearByApp)) <CLLocationManagerDelegate>
...
SWIFT_CLASS("_TtC9NearByApp13SceneDelegate")
